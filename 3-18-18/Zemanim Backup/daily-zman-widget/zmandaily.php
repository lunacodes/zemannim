...
class AdatoSystems_DailyZman_Widget extends WP_Widget {
    ...
    */
    ...
    // function enqueue_google_maps_api() {
        ...
        // wp_enqueue_script( 'https://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js' );
        // wp_enqueue_script( '$http://maps.googleapis.com/maps/api/js?key=AIzaSyDFrCM7Ao83pwu_avw-53o7cV0Ym7eLqpc&callback=initialize' );
    // }
...
<!-- For some reason this needs to be in to run properly... I'm not sure why -->
...
//     console.log("this is a script test");
...
// </script>
// ';
// echo("Var Test: $lat1 $long1");

$url = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=40.714224,-73.961452&key=AIzaSyDFrCM7Ao83pwu_avw-53o7cV0Ym7eLqpc';
...
<script type="text/javascript" defer>
    ...
    // window.get_test = "I want my GET";
        ...
        <?php
            ...
            echo("<br>New section <br>IP is: $ip<br>");
